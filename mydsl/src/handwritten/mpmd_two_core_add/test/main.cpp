// main.cpp — phase 2 step 3 test driver for mpmd_two_core_add
//
// Same C = A + B reference as two_core_add. The "MPMD" twist is purely
// in the host wiring (separate kernel binaries per core); the math is
// identical, so the bit-exact reference still applies.
