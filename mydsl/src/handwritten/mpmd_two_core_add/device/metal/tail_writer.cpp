...
// tail_writer.cpp — phase 2 step 3 (true MPMD)
//
// Tail core's writer (BRISC): drain pc to DRAM. Same shape as the
// consumer branch of two_core_add_writer.cpp's core_id==1 path, factored
// into its own kernel binary.
